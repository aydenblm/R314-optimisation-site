/* metrics.js — widget d'évaluation des performances (client-side)
   ...
   ATTENTION : ce widget n'est PAS chargé par défaut. Il ne s'active que si
   l'URL contient le paramètre ?perf=1 (ex. index.html?perf=1), afin qu'il
   ne fausse pas les mesures Lighthouse et ne s'ajoute pas au poids de la
   page que vous devez optimiser. */
(function(){
  ...
  `;
  // Le script peut être injecté après DOMContentLoaded (cas de ?perf=1) :
  // on gère les deux situations.
